...
function keep_streaming {
  ...
  pacat -r --rate=8000 --server=$NIGHTCALL_SINK_HOSTNAME --volume=65536 --latency-msec=200 --process-time-msec=200 | pacat -p --device=nirvana --rate=8000 --volume=65536 --latency-msec=200 --process-time-msec=200 --client-name=remotephone --stream-name=remotephone --server=127.0.0.1 > "$LOG" 2>&1 &
  PID=$!
